// Resources
// https://stackoverflow.com/questions/15463977/converting-code-from-c-to-c-typedef-void-and-unresolved-overloaded-function
...
int main() {
    stdio_init_all();
    for (int i=0;i<15;i++){
        printf("waiting %d seconds to initialize\n", i);
        sleep_ms(1000);
    }
